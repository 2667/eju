...
{
    self = [self initWithWidth:kTMFloatingButtonDefaultSize withMargin:kTMFloatingButtonDefaultMargin andPosition:FloatingButtonPositionBottomRight andHideDirection:FloatingButtonHideDirectionLeft andSuperView:superView];
    return self;
}

- (instancetype)initWithWidth:(CGFloat)width withMargin:(CGFloat)margin andSuperView:(UIView *)superView
{
    self = [self initWithWidth:width withMargin:margin andPosition:FloatingButtonPositionBottomRight andHideDirection:FloatingButtonHideDirectionRight andSuperView:superView];
    return self;
}
...
- (void)updateFrameWithPosition:(FloatingButtonPosition)postion
{
    ...
    switch (postion) {
        ...
        case FloatingButtonPositionBottomRight:
            frameForButton = CGRectMake(self.superview.frame.size.width - _size - _margin+40, self.superview.frame.size.height - _size - _margin, _size, _size);
            break;
